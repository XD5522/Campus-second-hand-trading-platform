...
public interface UserMapper extends BaseMapper<User> {
    ...
    @Select("select * from user where flag = 0 and (state = 'audit' or state = '审核未通过') and type = '普通用户' ")
    ...
    @Select("select * from user where flag = 0 and (state = 'audit' or state = '审核未通过') and type = '商家' ")
